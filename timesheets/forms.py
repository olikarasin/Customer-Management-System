...
class TimesheetForm(forms.ModelForm):
    class Meta:
        model = Timesheet
        fields = ['timesheet_id', 'date', 'time_in', 'time_out', 'technician', 'technician_level', 'special_rate', 'pause', 'file', 'notes']
        widgets = {
            ...
            'pause': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '1h45'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['pause'].label = "Pause (e.g., 1h45)"
